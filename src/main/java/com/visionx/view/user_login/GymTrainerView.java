...
public class GymTrainerView {
    ...
    private void showMessageWindow(
        ...
        javafx.scene.control.Button videoCallBtn = new javafx.scene.control.Button("📹 Video Call");
        videoCallBtn.setStyle(
                "-fx-background-color:#1a2936;" +
                "-fx-text-fill:#62ff96;" +
                "-fx-font-weight:bold;" +
        ...
        videoCallBtn.setOnMouseEntered(e -> videoCallBtn.setStyle(
                "-fx-background-color:#2a3946;" +
                "-fx-text-fill:#62ff96;" +
                "-fx-font-weight:bold;" +
                "-fx-background-radius:6px;" +
                "-fx-padding:8px 12px;" +
        ...
        videoCallBtn.setOnMouseExited(e -> videoCallBtn.setStyle(
                "-fx-background-color:#1a2936;" +
                "-fx-text-fill:#62ff96;" +
                "-fx-font-weight:bold;" +
                "-fx-background-radius:6px;" +
        ...
        videoCallBtn.setOnAction(e -> {
            ...
            alert.setHeaderText("Connecting to " + trainerName + "...");
            alert.setContentText("Video calling feature is currently under development.");
            alert.showAndWait();
        });
